# Stephanie Rodriguez _ Edit this file according to the instructions
...
star_wars_release = [1977, 1980, 1983, 1999, 2020, 2005, 2015, 2017, 2019]
...
numbers = [1, 2, 3]
first, second, third = numbersprint(first, second, third)
print(first, second, third)

numbers = [1, 2, 3, 4, 4, 4, 4, 4]
first, second, *other = numbersprint(first)
print(first)
print(*other)
...
for year in star_wars_release:
    print(year)
# Note. lady and year are just variable names. You can use any variable name.
# Best practice is to name lists with plural nouns and 
# use the singular noun in the for loop

# Looping through a list inside a list using unpacking
for move, total in star_wars_box_office:
...
still_more)vegies = ["cabbage", "garlic", "bok choy"]
...
# What if you want to sort a complex object, such as items, by quanity
items - [
    ("Product1", 10),
    ("Product2", 9),
    ("Product4", 7),
...
# does not sort by quantity, only product name
items.sort()
print(items)
