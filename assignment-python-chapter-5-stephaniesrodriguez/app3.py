...
print("n\Chapter 5.14 Queues" + "-" * 20)
queue = deque([])
queue.append(1)
queue.append(2)
queue.append(3)
...
# old way of swapping variable values
x = 10
y = 11
z = x
x = y
...
mlb_teams["Miami"] = "Marlins"
print(mlb_teams)

# use .get() to get a key value pair that may not be in in dictionary
